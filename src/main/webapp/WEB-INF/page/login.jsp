...
<html>
    <head>
        <title>欢迎您登录内部管理系统</title>        
	<%@ include file="/common/meta.jsp" %>
    <%@ include file="/common/import.jsp" %>
        
        <link rel="stylesheet" type="text/css" href="${ctx}/login/css/login.css" media="all">
       	<link rel="stylesheet" type="text/css" href="${ctx}/login/css/default_color.css" media="all">
    </head>
    <body id="login-page">
        <div id="main-content">
            ...
            <div class="login-body">
                <div class="login-main pr">
                    <form id="formLogin" action="${ctx}/loginJson.action" method="post" class="login-form">
                       <h3 class="welcome">
...
<!--                            
                            ...
                            <div>
                                <img class="verifyimg reloadverify" alt="点击切换" src="/demo/admin.php?s=/public/verify.html">
                            </div>
 -->                            
                        </div>
                        <div class="login_btn_panel">
                            <button class="login-btn" type="submit" onclick="login();">
	...
	<!--[if lt IE 9]>
    <script type="text/javascript" src="${ctx}/login/static/jquery-1.10.2.min.js"></script>
    <![endif]-->
    <!--[if gte IE 9]><!-->
    <script type="text/javascript" src="${ctx}/login/static/jquery-2.0.3.min.js"></script>
    <!--<![endif]-->
