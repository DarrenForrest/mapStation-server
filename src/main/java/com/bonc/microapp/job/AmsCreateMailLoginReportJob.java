...
public class AmsCreateMailLoginReportJob extends CommonJob {
	
	private AmsService amsService;

	@Override
	protected String ownerJob(JobDefine jobDefine, long triggerType, Long exeFlowId) throws TxException {
		System.out.println("AmsCreateMailLoginReportJob: execute...............");
		...
		String ret = amsService.txCreateMail4ActionReport(F.ACTION_LOGIN);
		System.out.println("AmsCreateMailLoginReportJob ret = " + ret );
